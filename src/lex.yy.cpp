...
{
  static const char *REGEX_INITIAL = "(?m)((?:\\Qtrue\\E))|((?:\\Qfalse\\E))|((?:\\Qif\\E))|((?:\\Qelif\\E))|((?:\\Qelse\\E))|((?:\\Qwhile\\E))|((?:\\Qreturn\\E))|((?:\\Qstate\\E))|((?:\\Qentry\\E))|((?:\\Qexit\\E))|((?:\\Qon\\E))|((?:\\Qmoveto\\E))|((?:\\Qlambda\\E))|((?:\\Qdefevent\\E))|((?:\\Qint\\E))|((?:\\Qbool\\E))|((?:\\Qstring\\E))|((?:\\Q+\\E))|((?:\\Q;\\E))|((?:\\Q{\\E))|((?:\\Q}\\E))|((?:\\Q(\\E))|((?:\\Q)\\E))|((?:\\Q,\\E))|((?:\\Q=<\\E))|((?:\\Q=>\\E))|((?:\\Q<\\E))|((?:\\Q>\\E))|((?:\\Q==\\E))|((?:\\Q=\\E))|([A-Z_a-z][0-9A-Z_a-z]*)|([0-9]+)|((?:\\Q/*\\E)(?:.|\\n)*?(?:\\Q*/\\E))|([\\x09\\x0a\\x0d\\x20])";
...
return yy::parser::make_ASSIGN(str());
            break;
          case 31: // rule at line 48: [A-Z_a-z][0-9A-Z_a-z]*
#line 48 "lexerspec.l"
return yy::parser::make_IDENTIFIER(str());
            break;
          case 32: // rule at line 49: [0-9]+
#line 49 "lexerspec.l"
return yy::parser::make_NUMBER(atoi(text()));
            break;
          case 33: // rule at line 50: (?:\Q/*\E)(?:.|\n)*?(?:\Q*/\E)
#line 50 "lexerspec.l"
/* no action: ignore multiline comments */
            break;
          case 34: // rule at line 51: [\x09\x0a\x0d\x20]
#line 51 "lexerspec.l"
